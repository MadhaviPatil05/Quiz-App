$(document).ready(function(){
    $("#sign-up-form").on("click", "#submit_login_form",function(){
        console.log("hello");
        $.ajax({
            url : "update_test_taken.php",
            type : "GET",
            dataType : "json",
            success : function(res){
                console.log(res);
                $(".total-display").html(res.data);
            }
        })
    })
})
...
const quizDb = [
    ...
    {
        question : "Q4 : What is the correct syntax for referring to an external script called â€œgeek.jsâ€ ?",
        a: "script src=â€geek.jsâ€",
        b: "script href=â€geek.jsâ€",
        c: "script ref=â€geek.jsâ€",
        d: "script name=â€geek.jsâ€",
        ans: "ans1" ,
        selected: ''  
    },
    {
    ...
    {
        question : "Q10S : What is the correct syntax for adding comments in JavaScript ?",
        a: "!â€“This is a commentâ€“ ",
        b: "//This is a comment ",
        c: "â€“This is a comment  ",
        d: "*This is a comment*",
        ans: "ans2  ",
        selected: '' 
    },
